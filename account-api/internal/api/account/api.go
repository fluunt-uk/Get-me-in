...
func VerifyEmail(w http.ResponseWriter, r *http.Request) {
	repo.Account.VerifyEmail(w, r)
}

func ResendVerification(w http.ResponseWriter, r *http.Request) {
	repo.Account.ResendVerification(w ,r)
}
